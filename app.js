...
var option_navigation_mode = "sticky",
    ...
    option_hero_background_space_star_speed = 1,
...
if (jQuery(window).load(function () {
        ...
        $(".navigation-main .navigation-items").onePageNav({
            ...
            viewFactor: .3,
            scale: 1
        })), "sticky" == option_navigation_mode && ($(".navigation-main"), $(".navigation-main.sticky-navigation").sticky({
            topSpacing: 0
                ...
                move: function () {
                    ...
                    function t(t) {x
                        if (null !== t.beta && null !== t.gamma) {
                            var e = t.gamma,
                                o = t.beta;
                            r.portrait || (e = -1 * t.beta, o = t.gamma), r.cursor_x = r.w / 2 + 5 * e, r.cursor_y = r.h / 2 + 1 * o
                        }
                    }
